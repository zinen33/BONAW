...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ JONELL CC ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
startBot();
// THIS BOT WAS MADE BY Arjhil Dacayanan And Remodfied by Jonell MAGALLANES - DO NOT STEAL MY CODE.
